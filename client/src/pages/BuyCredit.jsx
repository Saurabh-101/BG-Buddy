...
const BuyCredit = () => {
  const handlePayment = ()=>{
    toast.error('Payment gateway under development.')
  }
  return (
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {
          plans.map((item,index)=>(
            ...
            <div  className='bg-white drop-shadow-sm border-gray-600 rounded-lg py-12 px-8 text-gray-700 hover:scale-105 transition-all duration-500' key={index}>
